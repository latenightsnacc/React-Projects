        ...
        return (
            <>
                <div className="Buttons">
                    ...
                    <button className="button" name="%" title="modulus" onClick= {e => this.props.onClick(e.target.name)}>%</button>
                    ...
                    <button className="button" name="%" title="percent" onClick= {e => this.props.onClick(e.target.name)}>%</button>
                    <button className="button" name="." onClick= {e => this.props.onClick(e.target.name)}>.</button>
                    <button className="button" name="=" onClick= {e => this.props.onClick(e.target.name)}>=</button>
